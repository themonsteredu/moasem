...
const labels={
  ...
  en:{today:'Today’s results',solved:'Problems completed',wrong:'Incorrect answers',type:'Topics to practise',week:'This week’s homework',video:'Videos to watch together',watch:'Watch video',grade:(n:number)=>`Grade ${n}`,expires:'This link is available until'},
