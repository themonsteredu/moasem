...
export function canOpenWorkspace(staff: Staff, path: string) { return staff.role === 'admin' || path.startsWith('/students/') || ['/my-students', '/attendance', '/reports'].includes(path) }
